...
- To deploy this project I followed these steps:
    ...
    1. Open my [GitHub repository](https://github.com/gaspar91/MyJourney) project page.
...
- In order to run this project locally you should follow these steps:
    ...
    1. Click the green *'clone or download'* button in the [GitHub repository](https://github.com/gaspar91/MyJourney) for the project.
